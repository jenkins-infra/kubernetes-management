...
[Contributor License Agreement](https://github.com/jenkinsci/infra-cla/blob/master/README.md)
...
A Jenkins infrastructure Charts maintainer will review the Chart change submission.  A maintainer may add "LGTM" (Looks Good To Me) or an equivalent comment to indicate that a PR is acceptable. Any change requires at least one LGTM. No pull requests can be merged until at least one maintainer signs off with an LGTM.
